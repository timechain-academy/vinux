...
our %config = (
    ...
    "CC" => "cc",
    "CFLAGS" => [
        "-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.2.sdk -arch arm64"
    ],
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    ...
    "openssldir" => "/Users/Shared/randymcmillan/.github/vinux/git/LibGit2-iOS/install/iphoneos",
    "options" => "--prefix=/Users/Shared/randymcmillan/.github/vinux/git/LibGit2-iOS/install/iphoneos --openssldir=/Users/Shared/randymcmillan/.github/vinux/git/LibGit2-iOS/install/iphoneos no-acvp-tests no-afalgeng no-asan no-async no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-module no-msan no-padlockeng no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "4",
    "perl_archname" => "darwin-thread-multi-2level",
    "perl_cmd" => "perl",
    "perl_version" => "5.34.1",
    "perlargv" => [
        "--prefix=/Users/Shared/randymcmillan/.github/vinux/git/LibGit2-iOS/install/iphoneos",
        "--openssldir=/Users/Shared/randymcmillan/.github/vinux/git/LibGit2-iOS/install/iphoneos",
        "ios64-cross",
        "no-shared",
        "no-dso",
    ...
    "perlenv" => {
        ...
        "BUILDFILE" => undef,
        "CC" => undef,
        "CFLAGS" => "-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.2.sdk -arch arm64",
        "CPP" => undef,
        "CPPDEFINES" => undef,
        "CPPFLAGS" => undef,
        "CPPINCLUDES" => undef,
...
unless (caller) {
    ...
    use lib '/Users/Shared/randymcmillan/.github/vinux/Git/LibGit2-iOS/openssl-3.0.4/util/perl';
    use OpenSSL::fallback '/Users/Shared/randymcmillan/.github/vinux/Git/LibGit2-iOS/openssl-3.0.4/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/Shared/randymcmillan/.github/vinux/Git/LibGit2-iOS/openssl-3.0.4/Configurations';
        use gentemplate;
